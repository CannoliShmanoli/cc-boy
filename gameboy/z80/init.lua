...
local apply_arithmetic = require("z80/arithmetic")
local apply_bitwise = require("z80/bitwise")
local apply_call = require("z80/call")
local apply_cp = require("z80/cp")
local apply_inc_dec = require("z80/inc_dec")
local apply_jp = require("z80/jp")
local apply_ld = require("z80/ld")
local apply_rl_rr_cb = require("z80/rl_rr_cb")
local apply_stack = require("z80/stack")

local Registers = require("z80/registers")
...
function Z80.new(modules)
  ...
  z80.opcodes = opcodes
  z80.opcode_cycles = opcode_cycles
