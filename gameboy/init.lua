...
Gameboy.audio = require("audio")
Gameboy.cartridge = require("cartridge")
Gameboy.dma = require("dma")
Gameboy.graphics = require("graphics/")
Gameboy.input = require("input")
Gameboy.interrupts = require("interrupts")
Gameboy.io = require("io")
Gameboy.memory = require("memory")
Gameboy.timers = require("timers")
Gameboy.processor = require("z80/")
...
Gameboy.type = Gameboy.types.dmg
...
function Gameboy:load_rom(file_data, size)
  local size = size
  self.cartridge.load(file_data, size)
  self:reset()
end
